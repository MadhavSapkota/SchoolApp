...
public class ExamAdapter<S> extends RecyclerView.Adapter<ExamAdapter.MyHolder>{
    ...
    public ExamAdapter (List <Exam> list , exam_data_admin exam_data_admin) {
        this.list = list;
    ...
    public MyHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.examdataview,parent,false);
    ...
    @Override
    public void onBindViewHolder(ExamAdapter.MyHolder  holder, final int position) {
