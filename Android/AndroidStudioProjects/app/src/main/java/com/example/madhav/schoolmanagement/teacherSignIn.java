...
import com.example.madhav.schoolmanagement.Model.Student;
 ...
 */
public class teacherSignIn extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSignIn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final Student user = new Student(inputUsername.getText().toString(),
                ...
                TeacherLogin.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        if (dataSnapshot.child(user.getUsername()).exists())
                            Toast.makeText(teacherSignIn.this,"Please Enter the form.",Toast.LENGTH_SHORT).show();

                        else {
                            TeacherLogin.child(user.getUsername()).setValue(user);
                            Toast.makeText(teacherSignIn.this,"Sucess Registered",Toast.LENGTH_SHORT).show();
                            Intent intent = new Intent(teacherSignIn.this,teacherLogin.class);
                            startActivity(intent);
                            finish();
                        }
                    ...
                    public void onCancelled(@NonNull DatabaseError databaseError) {
                        Toast.makeText(teacherSignIn.this, "Database Error", Toast.LENGTH_SHORT).show();
                    }
    ...
    private void addEmailsToAutoComplete(List<String> emailAddressCollection) {
        ...
        ArrayAdapter<String> adapter =
                new ArrayAdapter<>(teacherSignIn.this,
