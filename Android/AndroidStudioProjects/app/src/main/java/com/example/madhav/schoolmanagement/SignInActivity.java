...
public class SignInActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        users = database.getReference("LoginUser");
                ...
                users.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        if (dataSnapshot.child(user.getUsername()).exists())
                            Toast.makeText(SignInActivity.this,"Please Enter the form.",Toast.LENGTH_SHORT).show();

                        else {
                            users.child(user.getUsername()).setValue(user);
                            Toast.makeText(SignInActivity.this,"Sucess Registered",Toast.LENGTH_SHORT).show();
                            Intent intent = new Intent(SignInActivity.this,LoginPage.class);
                            startActivity(intent);
                            finish();
                        }
