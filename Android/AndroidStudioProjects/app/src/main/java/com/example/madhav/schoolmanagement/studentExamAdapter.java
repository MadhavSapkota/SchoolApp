...
public class studentExamAdapter<S> extends RecyclerView.Adapter<studentExamAdapter.MyHolder>{
    public Context mContext;
    DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference();

    List<Exam> list;

    public studentExamAdapter (Context context) {
        mContext = context;
    }
    ...
    public studentExamAdapter (List <Exam> list , studentDisplayExamData studentDisplayExamData) {
        this.list = list;
    ...
    public MyHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.studentexamdataview,parent,false);
    ...
    @Override
    public void onBindViewHolder(studentExamAdapter.MyHolder  holder, final int position) {
        final  Exam data = list.get(position);

        holder.subject.setText(data.getSubject());
        holder.className.setText(data.getClassName());
        holder.examType.setText(data.getExamType());
...
//                            Exam userTemp = snapshot.getValue(Exam.class);
//                            if (data.getSubject().equals(userTemp.getSubject())) {
//                                databaseReference.child("Exam").child(snapshot.getKey().toString()).removeValue();
...
//            @Override
//            public void onClick (View view) {
//                Intent homeIntent =  new Intent(view.getContext(), exam_panel_admin.class);
...
//        public TextView student_batch;
        ...
        private TextView examType ,message,className,datePicker;;
//        private DatePicker
        ...
        public MyHolder(View itemView) {
            super(itemView);
            subject= itemView.findViewById(R.id.editText7);
            className= itemView.findViewById(R.id.editText17);
            examType= itemView.findViewById(R.id.editText5);
            message = itemView.findViewById(R.id.editText18);
            datePicker = itemView.findViewById(R.id.editText19);
