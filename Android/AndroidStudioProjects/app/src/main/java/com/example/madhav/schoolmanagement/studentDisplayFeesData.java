...
public class studentDisplayFeesData extends AppCompatActivity {
...
//    Fees fee;
    ...
    protected void onCreate (Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_student_display_fees_data);
...
//                Displaying values in the ListView
                FeesAdapterStudent recycler = new FeesAdapterStudent(list ,studentDisplayFeesData.this);
                RecyclerView.LayoutManager layoutmanager = new LinearLayoutManager(studentDisplayFeesData.this);
    ...
    public boolean onOptionsItemSelected(MenuItem menuItem) {
        switch (menuItem.getItemId()) {
            case android.R.id.home:
                Intent homeIntent = new Intent(studentDisplayFeesData.this, StudentPanel1.class);
