...
public class FeesAdapterStudent<S> extends RecyclerView.Adapter<FeesAdapterStudent.MyHolder>{
    ...
    public FeesAdapterStudent (Context context) {
        mContext = context;
    }
    ...
    public FeesAdapterStudent (List <Fees> list , studentDisplayFeesData studentDisplayFeesData) {
        this.list = list;
    ...
    public MyHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.feesdataviewstudent,parent,false);
    ...
    @Override
    public void onBindViewHolder(FeesAdapterStudent.MyHolder  holder, final int position) {
