...
public class studentDisplayExamData extends AppCompatActivity {
    ...
    protected void onCreate (Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_student_display_exam_data);
...
//                Displaying values in the ListView
                studentExamAdapter recycler = new  studentExamAdapter(list , studentDisplayExamData.this);
                RecyclerView.LayoutManager layoutmanager = new LinearLayoutManager(studentDisplayExamData.this);
    ...
    public boolean onOptionsItemSelected(MenuItem menuItem) {
        switch (menuItem.getItemId()) {
            case android.R.id.home:
                Intent homeIntent = new Intent(studentDisplayExamData.this, StudentPanel1.class);
